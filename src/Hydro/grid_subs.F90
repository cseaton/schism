...
!      write(12,*)'Elem ll=',ielg(ie),ar1*180.d0/pi,ar2*180.d0/pi
      ...
      eframe(1,2,ie)=-rearth_eq*cos(ar1)*sin(ar2)
      eframe(2,2,ie)=-rearth_eq*sin(ar1)*sin(ar2)
      eframe(3,2,ie)=rearth_pole*cos(ar2)
...
!      if(abs(egb2)<1.d-1) write(12,*)'Elem z-axis:',ielg(ie),egb1,eframe(:,:,ie)
  ...
  do j=1,nsa
    ...
    if(ics==1) then
      ...
      !zs axis using lon/lat
      call compute_ll(xcj(j),ycj(j),zcj(j),ar1,ar2)
      !1: zonal axis; 2: meridional axis; 3: outward radial
      swild(1,1)=-sin(ar1)
      swild(2,1)=cos(ar1)
      swild(3,1)=0._rkind
      swild(1,2)=-rearth_eq*cos(ar1)*sin(ar2)
      swild(2,2)=-rearth_eq*sin(ar1)*sin(ar2)
      swild(3,2)=rearth_pole*cos(ar2)
